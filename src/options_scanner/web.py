...
<fieldset class="filter-group context-group"><legend>Contexto técnico</legend><div class="filter-controls"><label class="control"><span class="control-label">Histórico {help_icon('help-history', 'Histórico', 'Ventana histórica utilizada para calcular soportes y resistencias del underlying. No modifica DTE, Greeks ni la cadena de opciones.')}</span><select name="historical_period"><option value="3m"{' selected' if v['historical_period']=='3m' else ''}>3M</option><option value="6m"{' selected' if v['historical_period']=='6m' else ''}>6M</option><option value="1y"{' selected' if v['historical_period']=='1y' else ''}>1A</option></select><small class="field-help">Ventana de análisis</small></label></div></fieldset></div>
