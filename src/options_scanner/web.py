...
<fieldset class="filter-group contract-group"><legend>Contrato</legend><div class="filter-controls"><label class="control"><span class="control-label">DTE: Min</span><input type="number" name="min_dte" min="0" value="{escape(v['min_dte'])}" required title="Días hasta vencimiento"><small class="field-help">Días hasta vencimiento</small></label><label class="control"><span class="control-label">DTE: Max</span><input type="number" name="max_dte" min="0" value="{escape(v['max_dte'])}" required title="Días hasta vencimiento"><small class="field-help">Días hasta vencimiento</small></label><label class="control"><span class="control-label">Distancia mínima<br>al strike (%)</span><input type="number" name="min_safety_margin" min="0" max="100" step="0.01" value="{escape(v['min_safety_margin'])}" required title="Distancia porcentual entre underlying y strike"><small class="field-help">Underlying ↔ strike</small></label></div></fieldset>
<fieldset class="filter-group short-put-group"><legend>Short PUT</legend><div class="filter-controls"><label class="control"><span class="control-label">|Delta|: Min</span><input type="number" name="min_abs_delta" min="0" max="1" step="0.01" value="{escape(v['min_abs_delta'])}" required title="Se filtra por valor absoluto de delta"><small class="field-help">Valor absoluto</small></label><label class="control"><span class="control-label">|Delta|: Max</span><input type="number" name="max_abs_delta" min="0" max="1" step="0.01" value="{escape(v['max_abs_delta'])}" required title="Se filtra por valor absoluto de delta"><small class="field-help">Valor absoluto</small></label><label class="control"><span class="control-label">IV mínima (%)</span><input type="number" name="min_iv" min="0" step="0.01" value="{escape(v['min_iv'])}" placeholder="Desactivada" title="Volatilidad implícita contractual mínima"><small class="field-help">Volatilidad contractual</small></label><label class="control"><span class="control-label">Theta short<br>mínimo</span><input type="number" name="min_short_theta" min="0" step="0.0001" value="{escape(v['min_short_theta'])}" placeholder="Desactivado" title="Exposición temporal favorable mínima para la posición corta"><small class="field-help">Exposición favorable</small></label></div></fieldset>
